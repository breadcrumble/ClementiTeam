...
$scope.createArray = function(object) {
  var newArray = [];
  newArray.push = object.incomeStatement.revenue;
  newArray.push = object.incomeStatement.netincome;
  newArray.push = object.cashflow.ocf;
$log.log(newArray);
  return newArray;
